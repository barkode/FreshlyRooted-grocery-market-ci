...
class OrderTest(TestCase):
	...
	def setUpTestData(cls):
		testuser1 = get_user_model().objects.create_user(username='testuser1', password='abcdef123')
		testuser1.save()
		...
		test_order = Order.objects.create(
			...
			country=CountryField(blank_label="Country *", null=False, blank=False).to_python('GB'),
	...
	def test_order_update(self):
		response = self.client.post(reverse('checkout:update_order', args='1'), {

...
class Order(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
        Override the save method to generate an order number if not provided.
        """
...
class OrderLineItem(models.Model):
    ...
    product_size = models.CharField(max_length=40, null=False, blank=False) 
    ...
    def save(self, *args, **kwargs):
        """
        Override the save method to calculate the line item total based on quantity and product price.
        """
